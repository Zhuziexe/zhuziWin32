...
#ifndef _ZHUZI_LAYOUT_NO_WARNINGS
#error "This class is an experimental class,and may cause bugs. Don't use it if you don't know what you are doing."
#endif
...
namespace zhuzi {
    ...
    public:
        ...
        virtual void destroy() override;   // 重写 destroy，清空子控件列表
